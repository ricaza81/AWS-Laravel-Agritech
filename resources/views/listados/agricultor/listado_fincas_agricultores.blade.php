            ...
            <?php
                ...
                <tr role="row" class="odd"  >
                      ...
                      <!--5--Ingresado-Por-->
                       ...
                       <!--3--CultivoFinca-->
                       <td><a href="javascript:void(0);"onclick="mostrarmodal(<?=$finca->id;?>);" style="display:block"><h4><span class="label label-info" style="background-color:#76a92b!important;">Ver variables meteorologicas</span></h4></a>          
                      </td>
 <td><a href="<?=$finca->urlreport?>" target="_blank" style="display:block"><h4><span class="label label-warning">Pronóstico</span></h4></a>          
                      </td>
    ...
    <div class="modal-content">
      ...
      <div class="box box-widget widget-user" style="margin-top: -10px;margin-left:0px;text-align: left;">
        ...
        <div class="box-footer" style="margin-bottom: 10px;/* margin-bottom: 10px; */width: 100%;padding:0;border: 7px solid #eee;">
          ...
          <form  id=""  method="post"  action="{{ url('/agregar_nueva_medicion_finca') }}" class="" enctype="multipart/form-data" >
                ...
                <div class="" data-swiper-parallax="-500" style="margin-top:0px;">
                    ...
                    <div class="day-wethear-item">
                        <div class="col-xs-3" style="float: left;">
                            <img class="responsive" src="{{asset('/css/clima/iconsoilt.png')}}" alt="Suelo" style="width:39px;margin-right:-18px"/>
                        </div>
                        <h5 class="description-header"><span id="soilTemperature"></span> &#8451;</h5>
                         <input type="text" name="soilTemperature_input" id="soilTemperature_input" style="color: #000000;">
...
document.getElementById("enlace").setAttribute('href',URL);
  ...
  $.getJSON("https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&units=metric" + "&lang=es" + "&appid=" + OPEN_WEATHER_MAP_API_KEY,function(data) {
    ...
    //$('#dewpoint').html( (data.main.dewpoint + 0) );
    });
