...
<div align="center" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 20px;" class="padding-copy"><h2>Datos capturados:</h2></div>
        ...
        <thead>
            <tr>               
                ...
                <th align="center"scope="col" style="width:20px;padding:20px 20px 20px 20px;border-bottom:3px solid #fff"><h3>Temperatura día: <br></h3><span class="span"><?=$tdia?> °C</span></th>
                 <th align="center"scope="col" style="width:20px;padding:20px 20px 20px 20px;border-bottom:3px solid #fff"><h3>Temperatura suelo: <br></h3><span class="span"></span></th>
            </tr>
            <tr>
    ...
    <th align="center"scope="col" style="width:20px;padding:20px 20px 20px 20px;border-bottom:3px solid #fff"><h3>Lluvia (mm): <br></h3><span class="span"><?=$precipi?></span></th>
                 <th align="center"scope="col" style="width:20px;padding:20px 20px 20px 20px;border-bottom:3px solid #fff; background:#ec6c4f"><h3>Rocio: <br></h3><span class="span" style="background:#ec6c4f"></span></th>
            </tr>
            <tr>
