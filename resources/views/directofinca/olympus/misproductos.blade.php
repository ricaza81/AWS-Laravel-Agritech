              ...
              <div class="page-description">
                <div class="icon">
                  <svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right" data-original-title="MIS PRODUCTOS">
                    <use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-star-icon')}}">
                    </use>
                  </svg>
                </div>
                     <span>ESTOS SON TUS PRODUCTOS PUBLICADOS.</span>
                  
                      <a href="{{asset('formnuevoproductoempresa')}}" class="btn btn-md-2 btn-primary">Publicar un producto Nuevo</a>
                              ...
                              <div class="author-date">
                                    <!--     <form method="post"  action="{{url('/contactardirecto')}}" class="">
                                              ...
                                              <div class="comments-shared">
                                                   <svg class="olymp-share-icon" data-toggle="tooltip" data-placement="right" data-original-title="Contacto Directo"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-share-icon')}}"></use></svg> <button id="contacto" type="submit" class="btn btn-md-2 btn-primary" style="font-size:15px;">Contactar</button>
                                                 </div>
                                     </form>-->
        ...
        <div class="widget w-wethear" style="background:#38a9ff">
          <div class="widget w-create-fav-page" style="background:#38a9ff">
                ...
                <div class="content" style="background:#38a9ff">
                  ...
                  <a href="{{asset('missolicitudes')}}" class="btn btn-bg-secondary btn-sm">Revisar</a>
                </div>
            </div>
        </div>
      </div>
