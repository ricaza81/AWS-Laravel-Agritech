...
<div class="row docs-premium-template">
  <div class="col-md-6">
    <div class="box box-primary col-xs-6">                
      ...
      <div class="callout callout-danger">Para iniciar por favor crea los productos que recomiendas en Campo</div>
       <?php } else if (count($productos)>0){   ?>      
     <span class="label pull-right bg-green"></span>  
      <?php } ?>
                    <h2 class="box-title"><b>Creación de un nuevo Producto:</b></h2>
                                           <div  style="
                                margin: auto;
                                box-shadow: none;
                                color: #76A82B;
