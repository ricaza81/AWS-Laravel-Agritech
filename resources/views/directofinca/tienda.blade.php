...
<script>
  ...
  <script>
    ...
    <link rel="author" href="https://www.directodefinca.com" />
    <link rel="canonical" href="https://www.directodefinca.com"/>
    <!-- FB Meta tags -->
    <meta property="og:title" content="Directo de Finca: Por un campo más justo"/>
    <meta property="og:type" content="website"/>
      <meta property="og:image" content="https://www.directodefinca.com/public/css/olympus/dfpreviewapp.jpg"/>
    <meta property="og:url" content="https://www.directodefinca.com"/>
  <!-- Bootstrap CSS -->
...
<div class="content-bg-wrap" style="background: #fff"></div>
                ...
                <div class="row sorting-container responsive text-center"  data-layout="masonry" style="background: rgb(65, 103, 178);position: relative;height: 167.391px;padding-top:30px;padding-bottom: 20px;">
                    ...
                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12  sorting-item ecommerce natural text-center" style="left: 0%;top:0">
                            ...
                            <div class="header--standard-wrap text-center" >
                                ...
                                <a href="#" class="logo" style="margin-right: 100px;">
                                    <div class="img-wrap text-center">
                                        <img src="{{url('imagenes/logotico.png')}}" alt="DF">
                                    
                                    </div>
                                    <div class="title-block text-center">
                                        <h3 class="logo-title">DirectodeFinca.com</h3>
    ...
    padding-bottom: 10px;">
        ...
        <ul class="breadcrumbs">
            <li class="breadcrumbs-item">
                 <span>Ir a:</span><a href="directofinca">Inicio</a>
    ...
    <div class="header--standard animated headroom--top headroom--not-bottom text-center responsive" style="background:url(https://www.directodefinca.com/public/imagenes/food.jpg)">
...
<li class="shoping-cart more" >
    ...
    color: #fff;">Ingresar como comprador</a>
                    ...
                    <img class="responsive" src="{{url('imagenes/vegetables.png')}}" alt="Directo de Finca">
                                        ...
                                        <form method="post" action="{{ url('/nuevo_carro') }}" class="">
                                            ...
                                            <div class="more text-right">
                                              <div class="comments-shared">
                                                   <svg class="olymp-share-icon" data-toggle="tooltip" data-placement="right" data-original-title="Contacto Directo"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-share-icon')}}"></use></svg> <button type="submit" class="btn btn-md-2 btn-primary" style="font-size:15px;">Comprar<div class="ripple-container"></div></button>
                                             </div>
                                            </div>
                                        </form>
