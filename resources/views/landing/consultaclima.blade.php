            ...
            <div class="ui-block" >
                 <div class="ui-block-content">
                    ...
                    <div class="ui-block-title inline-items">
                        <h1 class="title">Activar tu estación meteorológica virtual</h1><h5 style="float:right;">variables meteorológicas<br>En función de latitud y longitud.</h5>
...
<div class="container">
    ...
    <div class="row">
       ...
       <div class="col-md-12 text-center" style="margin-top: -64px;padding-bottom: 20px;">
            ...
            <div class="col col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="ui-block">
                      ...
                      <br><br>Puedes marcar la casilla "consultar mi ubicación"<!--o arrastrar el marcador para una nueva ubicación.--> <br> <span><a href="https://agronielsen.com/encampo/public/descargables/ConsultaFincaRisaraldaSept2020.pdf" target="_blank" style="color:#000">(Ver informe de ejemplo)</a></span>
                      ...
                      <form action="{{ url('/newclima') }}" method="post" id="">  
                          <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:-10px">
                                    <div class="form-group label-floating">
                                         <label class="control-label" style="color:#fff">Email</label>
                                              <input class="form-control" style="font-size: 20px;color:#fff;border:1px solid #fff;background: #1565C0;" type="email" placeholder="" id="email_report" name="email_report" required/>
                                    </div>
                                </div>
                                    ...
                                    <input class="form-control" style="font-size:8px" type="hidden" placeholder="" id="url" name="url"/>
                                     ...
                                     <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                         <label style="height: 35px;float:right;color:#000"> Total $0.00 (COP)
                                                </label>
                                                <!--<a style="font-size:25px;margin-top:0px;width:272px;padding-left:27px;background: #76A82B;float:right;" class="btn btn-purple btn-lg" href="https://checkout.wompi.co/l/72SHUi" target="_blank">Activar Estación
                                                </a>-->

                                                 <button style="font-size:25px;margin-top:0px;width:272px;padding-left:32px;background: #76A82B;float:right;" class="btn btn-purple btn-lg full-width" type="submit" id="query_1" name="query_1" onclick="ref()">Activar Estación
                                                 </button>
                ...
                <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12" style="background:#000;">
                     <div class="ui-block" style="background:#000">
                     <div class="ui-block-content" style="padding-bottom:25px;">
                  
                      
                                <a class="h2 post__author-name fn" href="02-ProfilePage.html" style="color:#fff;line-height:18px;letter-spacing:0px">Detalle de las mediciones</a>
                               <!-- <div id="map_canvas" class="map_canvas" style="height: 650px;width: 100%;">
                                </div>-->
                              
            <div id="generic_price_table" style="padding:20px;margin-top:20px">   
                    ...
                    <div class="generic_content active clearfix">
                        ...
                        <div class="generic_head_price clearfix">
                            ...
                            <div class="generic_head_content clearfix">
                                ...
                                <div class="head">
                                    <span>Medición de Variables Meteorológicas</span>
                                </div>
                                <!--//HEAD END-->
                            ...
                            <div class="generic_price_tag clearfix">    
                                <span class="price">
                                    ...
                                    <span class="currency">Sin costo</span>
                        ...
                        <div class="generic_feature_list">
                            <ul>
                                <li><span>4</span> <span>mediciones/dia</span>
                                   
                            <!--<a class="generic_price_btn clearfix" href="{{asset('register')}}">Gratis 15 dias</a>-->
                       
                                </li>
                                <li><span>Temperatura (°C) (máxima, mínima, promedio)</span></li>
                                <li><span>Humedad relativa(%)</span></li>
                                <li><span>Presión atmósferica (hPa)</span></li>
                                <li><span>Precipitación (mm agua)</span></li>
                                <li><span>Velocidad del viento (m/s)</span></li>
                                <li><span>Luminosidad (UVI)</span></li>
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <div class="generic_price_btn clearfix">
                            <a class="" href="https://bit.ly/3pbImdq" target="_blank">Ver reporte ejemplo</a>
                        </div>
                        <!--//BUTTON END-->
                    </div>    
                </div>
...
.col-6 {
  ...
  html {
    ...
    border-color: #e1762e rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #e1762e;
    color: #fff;
      }
