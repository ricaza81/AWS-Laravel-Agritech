 ...
 <section id="swape">
      <div class="container">
       <div class="section-title title-two" style="background-color: #fafbff; margin-top: 101px;">
          <h2>Base de Datos de Almacenes Agroveterinarios (DEMO)</h2>
        </div>
 <div class="section-title title-two" style="background-color: #fafbff; margin-top: 101px;">
   <iframe style="border: 0;" src="https://datastudio.google.com/embed/reporting/8794fd61-fa71-4d9e-a3c0-dcb502a6b9a3/page/FaZWB" width="1000" height="1100" frameborder="0" allowfullscreen="allowfullscreen">
   </iframe>
