...
<body id="home-version-2" class="home-version-2" data-style="default">
        ...
        <div class="container">
          <div class="header-inner clearfix">
            <div class="site-logo">
              ...
              <a href="landing" class="sticky-logo"><img src="{{url('css/appx/assets/img/sticky-logo1.png')}}" alt="Agronielsen en Campo"></a>
            </div>
            <!-- /.site-logo -->
 ...
 <section id="swape">
      <div class="container">
       <div class="section-title title-two" style="background-color: #fafbff; margin-top: 101px;">
          <h2>Informe de Ventas de las Empresas del Sector de Agroinsumos (DEMO)</h2>
          <p style="margin-top:-30px">Colombia 2014-2018</p>
        </div>
 <div class="section-title title-two" style="background-color: transparent; margin-top: 91px;">


   <!--<iframe width="1000" height="1000" src="https://datastudio.google.com/embed/reporting/1e2a982a-5208-42ba-8965-48b24fb1b90d/page/OtTXB" frameborder="0" style="border:0" allowfullscreen></iframe>-->

  <!--<iframe src="https://www.datos.gov.co/dataset/Temperatura/td23-kktk/embed?width=800&height=600" width="800" height="600" style="border:0; padding: 0; margin: 0;"></iframe>-->

<iframe width="1300" height="1200" src="https://datastudio.google.com/embed/reporting/1e2a982a-5208-42ba-8965-48b24fb1b90d/page/OtTXB" frameborder="0" style="border:0;margin-left:-100px" allowfullscreen></iframe>
