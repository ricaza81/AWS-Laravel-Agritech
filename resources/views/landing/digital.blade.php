...
<body id="home-version-2" class="home-version-2" data-style="default">
   ...
   <section id="download" style="margin: 0px 0 -2px;padding-bottom: 0px;padding-top: 143px;background:#fff;    margin-left: -160px;margin-bottom: 0px;">

    <div class="container">
        <div class="row">
            <div class="col-md-6" style="margin-top: 0px;margin-left:0px;margin-right:0px;padding-bottom: 121px;">
                 <div class="img-one" style="margin-left:-40px;margin-top:-43px;padding-top:0px;">
                            <img class="responsive" style="width:123%;margin-left:66px;margin-bottom:-150px;" src="{{url('css/appx/media/mkt/agronielsen-digital.jpg')}}" alt="Marketing Dital para el Agro" />
                 </div>
            </div>
        <div class="col-lg-6" style="margin-top: -69px;margin-bottom: 28px;">
            <div class="prosess-tabs-inner wow fadeInRight" style="margin-left: 197px;margin-top: -18px;">
                <h2 class="title" style="padding-top:100px;">
                    Especialistas en digitalización para el Campo
                </h2>
            <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                <div class="buttons-wrap">
                    <ul class="buttons" role="tablist">
                        ...
                        <li class="button active undefined">Web</li>
                        <li class="button">Redes Sociales</li>
                        <li class="button">Emailing</li>
                        <li class="button">E-commerce</li>
                    </ul>
                </div>
                    <div class="items" role="tabpanel" style="height: 237px;">
                        <div class="item active" data-title="Concept">
                            <div class="tab-content">
                                <p>
                                    Planeamos, diseñamos y desarrollamos el sitio web de tu marca que permite comunicar, visibilizar y comercializar tu portafolio de productos y servicios.
                                </p>
                                        <a target="_blank" href="https://mcooper81.typeform.com/to/rGNLeIgT" class="read-btn">Quiero iniciar<i class="ei ei-arrow_right"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="item" data-title="Design">
                                    <div class="tab-content">
                                        <p>
                                            Las redes sociales son un elemento clave en la estrategia de comunicación digital y hace parte de las acciones del marketing directo.
                                        </p>
                                        <a target="_blank" href="https://mcooper81.typeform.com/to/rGNLeIgT" class="read-btn">Quiero iniciar<i class="ei ei-arrow_right"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="item" data-title="Deployment">
                                    <div class="tab-content">
                                        <p>
                                            El email marketing es el envío inteligente de correos electrónicos dirigido a tu base de datos o contactos, como lo pueden ser tus clientes potenciales o prospectos.
                                        </p>
                                        <a target="_blank" href="https://mcooper81.typeform.com/to/rGNLeIgT" class="read-btn">Quiero iniciar<i class="ei ei-arrow_right"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="item" data-title="Support">
                                    <div class="tab-content">
                                        <p>
                                            El E-commerce significa comercio electrónico y es toda venta realizada en línea. Nace de la necesidad de disminuir la intermediación y llegar directamente a los consumidores.
                                        </p>
                                         <a target="_blank" href="https://mcooper81.typeform.com/to/rGNLeIgT" class="read-btn">Quiero iniciar<i class="ei ei-arrow_right"></i>
                                        </a>
                                    </div>
     ...
     <section id="download" style="padding-bottom: 25px;padding-top:24px;margin-bottom: 0px;background:#fff">
        <div class="container">
            <div class="row" style="">
                <div class="col-lg-6" style="padding-top:0px;">
                    <div class="prosess-tabs-inner wow fadeInRight">
                        <!--<h2 class="title" style="padding-top:172px;;margin-top: -43px;">-->
                        <h2 class="title">
                            Integramos todos los canales digitales y desarrollamos campañas 360 grados
                        </h2>
                        ...
                        <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                            <div class="buttons-wrap">
                                <ul class="buttons" role="tablist">
                                <li class="line brand-bg-color"></li>
                                    <li class="button active undefined">{{trans('messages.seccioncloudficha1')}}</li>
                                    <li class="button">Etapas</li>
                                    <li class="button">Acompañamiento</li>
                                    <li class="button">Seamos aliados</li>
                                </ul>
                            </div>
                            <div class="items" role="tabpanel">
                                <div class="item active" data-title="Concept">
                                    <div class="tab-content">
                                        <p>
                                           Analizamos su presencia digital, como su sitio web, redes sociales, bases de datos que cumplan los requisitos de protección de datos, presencia en google mi negocio, google search console y demás fuentes de tráfico.
                                        </p>
                                       <a target="_blank" href="https://mcooper81.typeform.com/to/rGNLeIgT" class="read-btn">Quiero iniciar<i class="ei ei-arrow_right"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="item" data-title="Design">
                                    <div class="tab-content">
                                        <p>
                                            Integrar todos los activos digitales de una marca, es un objetivo estratégico que impacta las ventas. Como todo proceso de transformación digital, es clave desarrollar un plan escalable para consolidar los beneficios del marketing digital.
                                        </p>
                                        <a href="https://mcooper81.typeform.com/to/rGNLeIgT" target="_blank" class="read-btn">Registrarme<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
                                <div class="item" data-title="Deployment">
                                    <div class="tab-content">
                                        <p>
                                            Trabajar inicialmente en la cultura más que en la tecnología, es clave la contribución del trabajo en equipo con nuestos clientes, entendiendo que el mayor conocimiento se logra de forma colectiva.
                                        </p>
                                        <a href="https://mcooper81.typeform.com/to/rGNLeIgT" target="_blank" class="read-btn">{{trans('messages.fichavalorbutton')}}<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
                                <div class="item" data-title="Support">
                                    <div class="tab-content">
                                        <p>
                                           Permítanos conocer de forma específica su necesidad en el proceso de transformación digital, registrando el formulario a continuación - tomará solamente 1 minuto y seria de mucha utilidad:
                                        </p>
                                        <a href="https://mcooper81.typeform.com/to/rGNLeIgT" target="_blank" class="read-btn">{{trans('messages.fichaproductbutton')}}<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                            ...
                            <img class="responsive" style="width:80%;margin-left:18px;padding-top: 54px;" src="{{url('css/appx/media/mkt/concepto-360-agronielsen.png')}}" alt="Marketing Dital para el Agro" />
                        ...
                        <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                            <div class="buttons-wrap">
                                <ul class="buttons" role="tablist">
                                    <li class="line brand-bg-color"></li>
                                    <li class="button active undefined">{{trans('messages.seccioncloudficha1')}}</li>
                                    <li class="button">{{trans('messages.seccioncloudficha2')}}</li>
                                    <li class="button">{{trans('messages.seccioncloudficha3')}}</li>
                                    <li class="button">{{trans('messages.seccioncloudficha4')}}</li>
                                </ul>
                            </div>
                            <div class="items" role="tabpanel">
                                <div class="item active" data-title="Concept">
        ...
        <div class="container">
            <div class="download-content text-center">
                ...
                <div class="store-btns">
                    <a
                        href="https://play.google.com/store/apps/details?id=io.ionic.agronielsen"
                        target="_blank"
