 ...
 <section id="swape">
      <div class="container">
       <div class="section-title title-two" style="background-color: #fafbff; margin-top: 101px;">
          <h2>Visor para análisis de datos Censo Agropecuario Colombia DANE</h2>
          <p style="margin-top:-30px">Colombia 2014</p>
          <p style="margin-top:-30px">Te recomendamos verlo desde tu PC</p>
        </div>
 <div class="section-title title-two full-width" style="background-color: transparent; margin-top: 91px;">


<iframe width="1000" height="1100" src="https://datastudio.google.com/embed/reporting/349d2a51-763b-471e-aa2e-9d673e726b60/page/mOlaB" frameborder="0" style="border:0" allowfullscreen></iframe>
