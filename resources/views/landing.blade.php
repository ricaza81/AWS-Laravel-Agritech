...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-M1SECW5QF0"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-M1SECW5QF0');
</script>

         <script type="text/javascript" src="{{url('js/globe/third-party/Detector.js')}}"></script>
  <script type="text/javascript" src="{{url('js/globe/third-party/three.min.js')}}"></script>
  <script type="text/javascript" src="{{url('js/globe/third-party/Tween.js')}}"></script>
  <script type="text/javascript" src="{{url('js/globe/third-party/globe.js')}}"></script>
    ...
    <link rel="stylesheet" href="{{url('css/appx/dependencies/swiper/css/swiper.min.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{url('css/appx/dependencies/simple-line-icons/css/simple-line-icons.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{url('css/appx/dependencies/wow/css/animate.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{url('css/appx/dependencies/slick-carousel/css/slick.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{url('css/appx/dependencies/magnific-popup/css/magnific-popup.css')}}" type="text/css" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5" style="margin-top:0px;">
                    <div class="prosess-tabs-inner wow fadeInRight">
                        <h2 class="title" style="padding-top: 31px;color:#000">
                        ...
                        <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                            <div class="buttons-wrap">
                                <ul class="buttons" role="tablist">
                                <li class="line brand-bg-color"></li>
                                    <li class="button active undefined" style="color:#000">{{trans('messages.seccioncloudficha1')}}</li>
                                    <li class="button" style="color:#000">Fincas</li>
                                    <li class="button" style="color:#000">{{trans('messages.seccioncloudficha3')}}</li>
                                    <li class="button" style="color:#000">{{trans('messages.seccioncloudficha4')}}</li>
                                </ul>
                            </div>
                            <div class="items" role="tabpanel">
                                <div class="item active" data-title="Concept">
                        ...
                        <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                            <div class="buttons-wrap">
                                <ul class="buttons" role="tablist">
                                    <li class="line brand-bg-color"></li>
                                    <li class="button active undefined" style="color:#000">{{trans('messages.seccioncloudficha1')}}</li>
                                    <li class="button" style="color:#000">{{trans('messages.seccioncloudficha2')}}</li>
                                    <li class="button" style="color:#000">{{trans('messages.seccioncloudficha3')}}</li>
                                    <li class="button" style="color:#000">{{trans('messages.seccioncloudficha4')}}</li>
                                </ul>
                            </div>
