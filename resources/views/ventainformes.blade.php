                 ...
                 <div class="header--standard-wrap">
                  ...
                  <div class="col col-lg-8 m-auto col-md-8 col-sm-12 col-12">
                    <div class="main-header-content">
                      <h1>Informes Especializados<b></b></h1>
                         <h3 >Mejores datos, para mejores decisiones</h3><br/>
                  </div>
                </div>
              </div>
             </div>
      ...
      <div class="col col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
        <div class="clients-grid">
                      ...
                      <div class="page-description" style="background:#76A82B">
                                ...
                                <span style="color:#ffffff">Informes Disponibles</span>
                      </div>
                      <!-- Post -->
        ...
        <article id="almacenes" class="hentry post" style="background:#ffffff">        
            <div class="post__author author vcard inline-items">        
              <div class="author-date">
                <a class="h6 post__author-name fn" href="https://checkout.wompi.co/l/q9DAwo">1. Base de Datos</a>
                <div class="post__date">
                  <time class="published" datetime="2017-03-24T18:18">
                    Almacenes Agroveterinarios con registro ICA. Colombia. 2013-2019
                  </time>
                </div>
              </div>             
            </div>        
          ...
          <div class="row">              
              <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <a href="{{asset('demoalmacenes')}}" target="_blank" class="btn btn-blue btn-lg full-width">Ver Demo</a>
              </div>          
              <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <a href="https://checkout.wompi.co/l/q9DAwo" class="btn btn-secondary btn-lg full-width">Comprar</a>
              </div>
           </div>         
        </article>

          <article id="sector" class="hentry post" style="background:#ffffff">        
            <div class="post__author author vcard inline-items">        
              <div class="author-date">
                <a class="h6 post__author-name fn" href="https://checkout.wompi.co/l/yUs4O0">2. Ventas Sector Agroinsumos</a>
                <div class="post__date">
                  <time class="published" datetime="2017-03-24T18:18">
                    Ranking 2018 agroquímicos y fertilizantes. Colombia. 2014-2018
                  </time>
                </div>
              </div>             
            </div>        
          ...
          <div class="row">              
              <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <a href="{{asset('demosector')}}" target="_blank" class="btn btn-blue btn-lg full-width">Ver Demo</a>
              </div>          
              <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <a href="https://checkout.wompi.co/l/yUs4O0" class="btn btn-secondary btn-lg full-width">Comprar</a>
              </div>
           </div>         
        </article>
          ...
          <article id="sector" class="hentry post" style="background:#ffffff">        
            <div class="post__author author vcard inline-items">        
              <div class="author-date">
                <a class="h6 post__author-name fn" href="https://checkout.wompi.co/l/yUs4O0">3. Censo agropecuario DANE 2014</a>
                <div class="post__date">
                  <time class="published" datetime="2017-03-24T18:18">
                   Segmentación de cultivos en minifundios y latifundios.
                  </time>
                </div>
              </div>             
            </div>        
          ...
          <div class="row">              
              <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <a href="{{asset('analiticacultivos')}}" target="_blank" class="btn btn-blue btn-lg full-width">Ver Demo</a>
              </div>          
              <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <a href="https://checkout.wompi.co/l/yUs4O0" target="_blank" class="btn btn-secondary btn-lg full-width">Comprar</a>
              </div>
           </div>         
        </article>
           ...
           <div id="accordion" role="tablist" aria-multiselectable="true" class="accordion-faqs" style="padding:30px">
              ...
              <div class="card-header" role="tab" id="headingOne">
                <h3 class="mb-0">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                   Cuál es la diferencia entre el demo y comprar el informe?
            ...
            <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
              <p style="color:#000000">
               Nuestros informes dinámicos se diferencian por las siguientes variables:
               <li>1. Permiten realizar filtros para una mayor segmentación de la información,</li>
               <li>2. Al ser informes dinámicos, permiten un mejor análisis,</li>
            ...
            <div class="card-header" role="tab" id="headingOne-1">
              <h3 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne" class="collapsed">
                  Como puedo comprar un informe y descargar las fuentes de datos?
                  <span class="icons-wrap">
                           <svg class="olymp-plus-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-plus-icon')}}"></use></svg>
                      <svg class="olymp-accordion-close-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-accordion-close-icon')}}"></use></svg>
                          </span>
            ...
            <div id="collapseOne-1" class="collapse" role="tabpanel" aria-labelledby="headingOne-1">
              <p style="color:#000000">
                Una vez se realice la transacción de compra, usted obtiene un usuario y contraseña para acceder a nuestros tableros de información, y de igual forma obtendrá todas las fuentes de datos utilizadas para obtener los reportes dinámicos en Agronielsen.com
              </p>
            </div>
            ...
            <div class="card-header" role="tab" id="headingOne-2">
              <h3 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-2" aria-expanded="true" aria-controls="collapseOne" class="collapsed">
                  Que obtengo cuando decido comprar un informe?
                  <span class="icons-wrap">
                           <svg class="olymp-plus-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-plus-icon')}}"></use></svg>
                      <svg class="olymp-accordion-close-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-accordion-close-icon')}}"></use></svg>
                          </span>
            ...
            <div class="card-header" role="tab" id="headingOne-3">
              <h3 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-3" aria-expanded="true" aria-controls="collapseOne" class="collapsed">
                  Cuánto tiempo tengo para acceder a los informes comprados?
                  <span class="icons-wrap">
                           <svg class="olymp-plus-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-plus-icon')}}"></use></svg>
                      <svg class="olymp-accordion-close-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-accordion-close-icon')}}"></use></svg>
                          </span>
            ...
            <div id="collapseOne-3" class="collapse" role="tabpanel" aria-labelledby="headingOne-3">
              <p style="color:#000000">
                Con su usuario y contraseña, podrá acceder en tiempo ilimitado los reportes e información que lo hacen un cliente premium en nuestra plataforma.
              </p>
            </div>
             ...
             <div class="card-header" role="tab" id="headingOne-4">
              <h3 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-4" aria-expanded="true" aria-controls="collapseOne" class="collapsed">
                  Adicional al informe dinámico, que otras fuentes de datos obtengo?
                  <span class="icons-wrap">
                           <svg class="olymp-plus-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-plus-icon')}}"></use></svg>
                      <svg class="olymp-accordion-close-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-accordion-close-icon')}}"></use></svg>
                          </span>
            ...
            <div id="collapseOne-4" class="collapse" role="tabpanel" aria-labelledby="headingOne-4">
              <p style="color:#000000">
                El informe dinámico le permite obtener información segmentada de acuerdo a nuestra arquitectura de información, sin embargo, si usted prefiere realizar informes personalizados, Agronielsen.com hace entrega de todas las fuentes de información en formato de Excel, PDF y de ser necesario la estructura de datos de nuestra base de fuentes de origen.
              </p>
            </div>

              <div class="card-header" role="tab" id="headingOne-5">
              <h3 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-5" aria-expanded="true" aria-controls="collapseOne" class="collapsed">
                 Cómo accedo a los informes que he comprado?
                  <span class="icons-wrap">
                           <svg class="olymp-plus-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-plus-icon')}}"></use></svg>
                      <svg class="olymp-accordion-close-icon"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-accordion-close-icon')}}"></use></svg>
                          </span>
            ...
            <div id="collapseOne-6" class="collapse" role="tabpanel" aria-labelledby="headingOne-6">
              <p style="color:#000000">
