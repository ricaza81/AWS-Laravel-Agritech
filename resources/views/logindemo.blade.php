  ...
  <body class="mini-sidebar">
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:
    {{url('/imagenes/field-min.jpg')}};height;10%">
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="" style="width:80%" src="{{asset('/imagenes/map-agronielsen.png')}}">
      </div>
...
<!--variable-->
  ...
  <div class="form-group m-t-20">
                                    <div class="col-xs-12">
                                         <input class="form-control" type="text" required="" value="demo1@agronielsen.com" name="email">
                                     </div>
                                  </div>
                            ...
                            <div class="form-group text-center m-t-20">
                              <div class="col-xs-12">
                                <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Ir al Demo</button>
