...
.featureLinksIcon.featureIconWall {
    ...
    <!--=        Banner          =-->
    <!--==========================-->
  <div id="site-banner1" style="padding-top:40px">
          ...
          <div class="col-md-7">
            <div class="banner-content" style="padding-top:198px">
              ...
              <p class="sub-title wow fadeInUp" data-wow-delay="0.5s">
                Con Agronielsen en campo, obtienes mejores rutas de tus visitas técnicas, <br>mayor seguimiento de las visitas de seguimientos posteriores, <br>y mayor efectividad de tus campañas de mercadeo.
              </p>

              <a href="register" class="banner-btn wow fadeInUp" data-wow-delay="0.7s">Quiero crear una cuenta</a>
            </div>
            <!-- /.banner-content -->
          </div>
          <!-- /.col-md-6 -->
...
#site-banner1 {
    ...
    background-image: linear-gradient(-74deg, #76A82B -6%, #2BA840 171%);
            ...
            <div class="banner-mobile">
              <div class="feature-image">
                <img src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/pdto/2.png" class="wow fadeInUp" alt="Mobile">
              </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="prosess-tabs-inner wow fadeInRight">
              <h2 class="title">
                Por qué Agronielsen en Campo mejora tu estrategia de mercadeo?
              </h2>
              ...
              <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                <div class="buttons-wrap">
                  <ul class="buttons" role="tablist">
                    ...
                    <li class="button active undefined">Rutas</li>
                    <li class="button">Seguimiento</li>
                    <li class="button">Mercadeo</li>
                    <li class="button">Soporte</li>
                  </ul>
                </div>
                <div class="items" role="tabpanel">
                  <div class="item active" data-title="Concept">
                    <div class="tab-content">
                      <p>
                        ...
                        datos de Agricultores, sus fincas, los ingenieros que los asesoran y las visitas técnicas realizadas. El análisis de datos te permitirá priorizar y segmentar tus agricultores para ofrecer una mejor asesoría técnica. 
                      </p>
                  ...
                  <div class="item" data-title="Design">
                    <div class="tab-content">
                      <p>
                        La asesoría técnica es un ciclo continúo que permite hacer seguimiento a los resultados en campo de los productos recomendados. Cada visita técnica genera una nueva visita técnica planeada que podrás hacer seguimiento a través de la plataforma de Agronielsen en Campo.
                      </p>
                  ...
                  <div class="item" data-title="Deployment">
                    <div class="tab-content">
                      <p>
                        Ésta es una <b>variable clave</b> para mejorar la efectividad en ventas. Tendrás la posibilidad de fortalecer tu estrategia de mercadeo al lograr priorizar y segmentar tus agricultores por cultivo, identificando cuál es el mejor medio de asesoramiento: si la asistencia técnica o actividades de mercadeo dirigidas al canal de distribución.                        
                      </p>
                    </p>
                  ...
                  <div class="item" data-title="Support">
                    <div class="tab-content">
                      <p>
                        Gran parte de la efectividad en ventas se mide por medio de la recompra de los Agricultores, siendo el soporte técnico y seguimiento en campo una variable clave para lograr este objetivo. El detalle de tu gestión técnica en Agronielsen en Campo te permitirá tener una mejor comunicación y soporte técnico con tus productores.
                      </p>
                        <a href="register" class="read-btn">Iniciar<i class="ei ei-arrow_right"></i></a>
                    </div>
                  </div>
          ...
          <!-- /.col-lg-5 -->
                    <div class="col-lg-6">
                      <div class="prosess-feature-image wow fadeInLeft text-right">
                        <h3 class="box-title">Geoposición de Fincas</h3>
                            <div id="map"style="width:80%;height:80%;float:right">
                            </div>
                      </div>
                    </div>
          <!-- /.col-lg-7 -->
    ...
    <!-- /#prosess -->
      ...
      <div class="container">
        <div class="row">
                    <div class="col-lg-6">
                      <div class="prosess-feature-image wow fadeInLeft text-left">
                        <h3 class="box-title">Geoposición de Asistencias Técnicas</h3>
                            <div id="map2"style="width:80%;height:80%;float:left">
                            </div>
                      </div>
                    </div>
          <div class="col-lg-6">
            <div class="prosess-tabs-inner wow fadeInRight">
              <h2 class="title">
                Geoposición de Fincas y Visitas Técnicas
              </h2>
              ...
              <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                <div class="buttons-wrap">
                  <ul class="buttons" role="tablist">
                    <li class="line brand-bg-color"></li>
                    <li class="button active undefined">Cobertura</li>
                    <li class="button">Fotos</li>
                    <li class="button">Rendimiento</li>
                    <li class="button">Potencial</li>
                  </ul>
                </div>
                <div class="items" role="tabpanel">
                  <div class="item active" data-title="Concept">
                    <div class="tab-content">
                      <p>
                        Cada vez que creas una nueva finca o visita técnica, el sistema obtiene automáticamente la geoposición por medio de la latitud y longitud. En el panel de administración de Agronielsen en Campo, obtienes el mapa consolidado de todas estas geoposiciones, permitiendo hacer una aproximación en cobertura geográfica de toda la gestión realizada por la empresa y sus asesores técnicos.
                      </p>
                      <a href="register" class="read-btn">Crear una Cuenta<i class="ei ei-arrow_right"></i></a>
                    </div>
                  </div>
                  <div class="item" data-title="Design">
                    <div class="tab-content">
                      <p>
                        El registro fotográfico de cada visita técnica es importante para tener un punto de referencia del estado del cultivo antes y después de las aplicaciones de productos. Agronielsen en Campo, te permite registrar las fotos de cada visita técnica, enviarlas en el reporte al agricultor y crear un banco de fotos para uso en próximas comunicaciones de mercadeo y análisis del area técnica y comercial.
                      </p>
                      <a href="register" class="read-btn">Registrarme<i class="ei ei-arrow_right"></i></a>
                    </div>
                  </div>
                  <div class="item" data-title="Deployment">
                    <div class="tab-content">
                      <p>
                        Agronielsen en Campo, te permitirá realizar análisis de rendimiento por medio de los reportes automáticos en el panel de control y administración.
                      </p>
                      <a href="register" class="read-btn">Iniciar<i class="ei ei-arrow_right"></i></a>
                    </div>
                  </div>
                  <div class="item" data-title="Support">
                    <div class="tab-content">
                      <p>
                        Cada agricultor que se encuentra en tu base de datos representa una oportunidad de asesoramiento en campo y un posible consumo de productos de tu portafolio. Contar con las hectareas consolidadas por cultivo permitirá cuantificar un estimado del potencial de tus agricultores.
                      </p>
                      <a href="register" class="read-btn">Registrarme<i class="ei ei-arrow_right"></i></a>
                    </div>
                  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="prosess-tabs-inner wow fadeInRight">
              <h2 class="title">
                Reportes automáticos de Gestión Consolidada de la Empresa y su fuerza de ventas
              </h2>
              ...
              <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                <div class="buttons-wrap">
                  <ul class="buttons" role="tablist">
                    <li class="line brand-bg-color"></li>
                    <li class="button active undefined">Reportes</li>
                ...
                <div class="items" role="tabpanel">
                  <div class="item active" data-title="Concept">
                    <div class="tab-content">
                      <p>
                        Agronielsen en Campo generá informes automáticos consolidando toda gestión en campo realizada por la Empresa y su equipo de trabajo. Estos reportes se envían cada semana a su correo electrónico mostrando por ejemplo: Número de hectareas visitadas y recomendadas, Su valorización total, número de visitas técnicas y número de integrantes de su fuerza de ventas.
                      </p>
                      <a href="register" class="read-btn">Crear una Cuenta<i class="ei ei-arrow_right"></i></a>
                    </div>
                  </div>
          ...
          <div class="col-lg-6">
            <div class="prosess-feature-image wow fadeInLeft text-right">
              ...
              <div class="img-two fadeInDown">
                <img src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/pdto/reporte-cron-consolidado.png" alt="Prosess">
              </div>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="prosess-feature-image wow fadeInLeft text-right">
              ...
              <div class="img-two fadeInDown">
                <img src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/pdto/reporte-cron-vt-asesor.png" alt="Prosess" style="max-width:100%;margin-left:0px;margin-top:40px">
              </div>
          ...
          <div class="col-lg-6">
            <div class="prosess-tabs-inner wow fadeInRight">
              <h2 class="title">
                Agenda automática de Visitas Técnicas Planeadas
              </h2>
              ...
              <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                <div class="buttons-wrap">
                  <ul class="buttons" role="tablist">
                    <li class="line brand-bg-color"></li>
                    <li class="button active undefined">Agenda automática</li>
                ...
                <div class="items" role="tabpanel">
                  <div class="item active" data-title="Concept">
                    <div class="tab-content">
                      <p>
                        Cada vez que un asesor o representante técnico comercial reporta una visita técnica, se registra una nueva fecha de seguimiento, ésta es registrada en el sistema y la agrega a la agenda de cada asesor. Cada día el sistema notifica a los usuarios de las próximas visitas técnicas planeadas y los agricultores que requieren seguimiento.
                      </p>
                      <a href="register" class="read-btn">Crear una Cuenta<i class="ei ei-arrow_right"></i></a>
                    </div>
                  </div>
...
<section id="site-banner" style="padding-top:40px">
    
      <div class="bn-bg">
      <!--  <img src="media/banner/c1.png" alt="bn bg" data-parallax='{"x" : 150, "y" : -150}'>
        <img src="media/banner/c2.png" alt="bn bg" data-parallax='{"x" : 100, "y" : -100}'>
        <img src="media/banner/c3.png" alt="bn bg" data-parallax='{"x" : 50, "y" : -50}'>-->
      </div>
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <div class="banner-content">
              <h3 class="title wow fadeInUp">Crea tu cuenta</h3>
              <h2 class="title wow fadeInUp" data-wow-delay="0.3s">y empieza a obtener los beneficios de tus datos</h2>

              <p class="sub-title wow fadeInUp" data-wow-delay="0.5s">
                Aprovecha las oportunidades que brinda internet y la nube, disminuyes el uso de tus formatos impresos de recomendación en campo, administras mejor los datos y los obtienes cuando necesites. Solo se requiere una conexión a internet.
                También ayudas al medio ambiente, ayudando a disminuir la tala de árboles y sus consecuencias.
              </p>
               <!-- Debido a su potencial de producir conocimientos predictivos precisos de enormes volúmenes de datos diversos, la minería de datos ha demostrado ser un componente valioso de muchas iniciativas analíticas.
                <a href="https://www.idc.com/" target="_blank">"IDC</a> ESTIMA QUE LAS EMPRESAS ANALIZAN MENOS DEL 1% DE TODOS SUS DATOS”.
              </p>-->

             <!-- <a href="#" class="banner-btn wow fadeInUp" data-wow-delay="0.7s">See How we Do it</a>-->
            </div>
            <!-- /.banner-content -->
          </div>
          <!-- /.col-md-6 -->
          ...
          <div class="col-md-5">
            <div class="banner-mobile" style="padding-top:140px">
            ...
            <h3 class="box-title text-center" style="padding: 10px 0 10px 0;background: #00A859;/*margin-bottom: 28px;*/color:#fff;border-radius: 4.25rem;font-size:18px;font-weight:450;font-family:"Montserrat", sans-serif;">Empieza la centralización!</h3>
