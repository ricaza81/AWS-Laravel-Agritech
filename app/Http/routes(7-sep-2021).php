...
Route::get('productoresoferta', 'DirectoProductorController@productoresoferta');Route::get('detalleconsulta/{slug}', ['as' => 'detalleconsulta', 'uses' => 'UsuariosController@slugdetalleconsultashow']);
...
/*Productosdelagricultor*/
 Route::get('misproductos', 'DirectoProductorController@misproductos');
